...
uint256 hashGenesisBlock("0x00000000ecdc245fd4cd1fe379461689a000207a2ade64132463bb29399fa8e0");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    // Subsidy is cut in half every 350000 blocks, which will occur approximately every 4 years
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x00000000ecdc245fd4cd1fe379461689a000207a2ade64132463bb29399fa8e0");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1429954412;
        block.nBits    = 486604799;
        block.nNonce   = 3001412243;
...
void static BitcoinMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        printf("Running PlatinumCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("PlatinumCoinMiner terminated\n");
        throw;
    }
}
